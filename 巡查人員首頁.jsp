...
<%
    ...
    if (session == null || session.getAttribute("account") == null || session.getAttribute("identity") == null || !"巡查人員".equals(session.getAttribute("identity"))) {
        response.sendRedirect("inspectorLogin.jsp");
        return;
    }
    ...
    try {
        ...
        String sql = "SELECT * FROM `新版使用者` WHERE 學號 = ? AND 身分 = '巡查人員'";
...
<body>
    <div class="container">
        ...
        <div>
			...
			<form action="巡查人員登入.jsp" method="get" style="display:inline;">
